    ...
    >
      <div className="container mx-auto px-4 py-8 max-w-7xl">
        ...
        <header className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-8 gap-4">
          <div>
            <h1 className="text-3xl font-bold inline-block px-3 py-1 bg-blue-50 dark:bg-blue-900/30 text-blue-700 dark:text-blue-300 rounded-lg">
                    ...
                    {Object.entries(dayLabels).map(([key, label]) => (
                      ...
                      >
                        <input
                          ...
                          className={`h-4 w-4 ${
                            darkMode ? "accent-blue-400" : "accent-blue-500"
                          }`}
                        />
                        <span>{label}</span>
                      </label>
                      ...
                      >
                        <div>
                          ...
                          <div className={`text-sm ${theme.secondaryText}`}>
                            {subject.duration} • {subject.days.join(", ")} •{" "}
